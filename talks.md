...
Extracted from https://raw.githubusercontent.com/congyuan-tan/aiesched/refs/heads/main/index.html.
...
- **Type:** sponsor
- **Speakers:** Charlie Guo (Developer Experience Engineer, OpenAI); Gabriel Chua (Developer Experience Engineer, OpenAI)
...
- **Track:** Workshops Day 1
- **Type:** sponsor
- **Speakers:** Shane Wolf (Atlassian); Andrei Bocan (Atlassian)
...
### AI Security Engineering 101

- **Time:** 9:00am-11:00am
- **Room:** Track 5
- **Track:** Workshops Day 1
- **Type:** sponsor
- **Speakers:** Javier Garza (Developer Advocate, Snyk)
...
- **Room:** Track 7
- **Type:** sponsor
- **Speakers:** Du'an Lightfoot (Senior AI Engineer, Akamai Technologies)
...
- **Track:** Workshops Day 1
- **Type:** sponsor
- **Speakers:** Zain Hasan (Staff AI/ML Engineer - DX, Together AI); Yubo Wang (LLM Inference, Together AI); Qingyang Wu (Staff Research Scientist, Together AI); Jue Wang (Senior Staff Researcher, Together AI)
...
- **Room:** Track 9
- **Type:** session
- **Speakers:** Doug Guthrie (Solutions Engineer, Braintrust)
...
- **Room:** Track M
- **Type:** sponsor
- **Speakers:** Pamela Fox (Principal Cloud Advocate, Microsoft)
...
### How to use Arize’s newest features
...
- **Room:** Track 2
- **Type:** sponsor
- **Speakers:** Nyah Macklin (Sr. Developer Advocate, Artificial intelligence, Neo4j)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Matt Brockman (AI Engineer, E2B)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Pamela Fox (Principal Cloud Advocate, Microsoft); Arun Sekhar (Microsoft)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Dhruv Nathawani (Research Scientist, Nvidia)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Ahmad Osman (Head mod, r/LocalLLaMA)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Nnenna Ndukwe (Principal Developer Advocate and Software Engineer, Qodo AI)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Charles Frye (Member of Technical Staff, Modal)
...
- **Room:** Track M
- **Type:** sponsor
- **Speakers:** Gustavo Cordido (Cloud Advocate & AI Content Engineer, Microsoft)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Tejas Kumar (AI Engineer, IBM)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Nick Nisi (Developer Experience Engineer, WorkOS); Zack Proser (AI Engineer, Applied AI, WorkOS)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Harshul Jain (Senior Software Engineer - ML/AI, Audible); Tanmay Sah (Senior Quantitative Modeler, Zions Bancorporation)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Wolfram Ravenwolf (AI Evangelist, Weights & Biases by CoreWeave)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Peter Werry (Founding Engineer, Unblocked)
...
- **Room:** Track 8
- **Type:** workshop
- **Speakers:** Yohan Raju (Pre-Sales Expert, Bright Data)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Paige Bailey (AI Developer Relations Engineering Lead, Google DeepMind)

### The Cheat Sheet: get evals up and running in minute with Agent Skills
...
- **Track:** Workshops Day 1
- **Type:** sponsor
- **Speakers:** Michael Forrester (AI Workforce Transformation, Accenture); Whitney Lee (Senior Technical Advocate, Datadog)
...
Ingest a mixed corpus (think insurance claims, legal filings, or medical intake forms), classify each doc, extract relevant fields per type, and route to downstream handlers. 
 We'll cover the full agentic document workflow end to end, and show you how to use Reducto Studio to do it.
...
- **Track:** Workshops Day 1
- **Type:** sponsor
- **Speakers:** Filip Makraduli (Founding Member of Technical Staff, Superlinked)
...
- **Track:** Workshops Day 1
- **Type:** sponsor
- **Speakers:** Lotte Verheyden (Clickhouse); Annabell Schäfer (Clickhouse)
...
- **Room:** Track 2
- **Type:** sponsor
- **Speakers:** Yoni Michael (Co-Founder, typedef)
...
- **Track:** Workshops Day 1
- **Type:** session
- **Speakers:** Daniel Han (Unsloth)

an advanced seminar (required prerequisites: Daniel's 2024 and 2025 hit AIE workshops)
...
- **Track:** Workshops Day 1
- **Type:** sponsor
- **Speakers:** Mark Lummus (PayPal); Navinkumar Patil (Staff Software Engineer, PayPal)
...
### AI Security Engineering 201

- **Time:** 2:20pm-4:20pm
- **Room:** Track 5
- **Track:** Workshops Day 1
- **Type:** sponsor
- **Speakers:** Micah Silverman (Director of Developer Relations, Snyk)
...
- **Room:** Track 7
- **Type:** sponsor
- **Speakers:** Jeff Vestal (Senior Principal AI Architect, Elastic)
...
- **Track:** Workshops Day 1
- **Type:** session
- **Speakers:** Emile Baizel (Amazon AGI Lab); Shruti Arora (Amazon AGI Lab)
...
- **Track:** Workshops Day 1
- **Type:** session
- **Speakers:** Zhengyao Jiang (CEO & Cofounder, Weco AI); Dixing Xu (Member of Technical Staff, Weco AI); Vayum Arora (Growth, Weco AI); Dhruv Srikanth (Founding Engineer, Weco AI)
...
- **Room:** Track 2
- **Type:** session
- **Speakers:** Paul Bakaus (Founder, Renaissance Geek, Inc.)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Shubhankar Srivastava (Founding Sales Engineer, Browserbase)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Bereket Habtemeskel (CEO, Better Auth); Paola Estefania (Staff Engineer, Better Auth)
...
### Prime Intellect Forge

- **Time:** 4:30pm-5:30pm
- **Room:** Track 6
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Will Brown (Researcher, Prime Intellect)

TBD — Prime Intellect Forge workshop abstract.
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** John Craft; Dan Ndombe (Staff Developer Success Advocate, Docker)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Joel Hooks (Co-founder; software developer and developer-education entrepreneur, badass.dev / egghead.io)
...
- **Track:** Workshops Day 1
- **Type:** workshop
- **Speakers:** Gagan Bhat (Software Engineer, Anthropic); Isabella Kai He (Applied AI, Anthropic)
...
- **Track:** Expo Stage 2
- **Type:** workshop
- **Speakers:** Joyce Zhang (Dating Coach for Tech Founders); Carole Robin, Ph.D. (Co-Founder, Leaders in Tech)
...
### Three Years of AI Engineering

- **Time:** 9:00am-9:05am
- **Room:** Main Stage
- **Track:** Software Factories
- **Type:** keynote
- **Speakers:** swyx (Curator, Latent Space / AI Engineer)
...
- **Track:** Software Factories
- **Type:** keynote
- **Speakers:** Pablo Castro (Distinguished Engineer and CVP, Microsoft)
...
- **Track:** Software Factories
- **Type:** keynote
- **Speakers:** Alexander Embiricos (Head of Enterprise Product, OpenAI); Romain Huet (Head of Developer Experience, OpenAI)
...
- **Track:** Software Factories
- **Type:** keynote
- **Speakers:** Thom Wolf (CTO, Hugging Face)
...
- **Track:** Software Factories
- **Type:** keynote
- **Speakers:** Zixuan Li (Head of Z.ai, Z.ai)
...
- **Room:** Expo Stage 2 NW
- **Type:** session
- **Speakers:** Dan Adler (Sourcegraph)
...
- **Type:** session
- **Speakers:** Nilofer Rajpurkar (Product Lead, Agent and Developer Experience, Stripe)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Jason Liu (Developer Experience, OpenAI, OpenAI)
...
- **Track:** Vision & OCR
- **Type:** sponsor
- **Speakers:** Joseph Nelson (Cofounder, CEO, Roboflow)
...
- **Type:** session
- **Speakers:** Edo Liberty (Founder and Chief Scientist, Pinecone)
...
- **Type:** session
- **Speakers:** Priyanka Phatak (Member of Technical Staff, Anthropic); Gabriel Cemaj (Member of the Technical Staff, Anthropic)
...
- **Type:** session
- **Speakers:** Kwindla Kramer (CEO, Daily)
...
- **Type:** session
- **Speakers:** Eno Reyes (CTO & Co-Founder, Factory)
...
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Ari Morcos (Co-founder, CEO, DatologyAI)

A talk on why better data selection and curation improve training efficiency and model quality.
...
- **Room:** Track M
- **Type:** sponsor
- **Speakers:** Idan Gazit (Head of GitHub Next, GitHub)
...
### Show your workflow: Reimagining AI PDLC with Skills

- **Time:** 11:00am-12:00pm
- **Room:** Leadership Lounge
- **Track:** CTO Circle
- **Type:** session
- **Speakers:** Martin Harrysson (Senior Partner, McKinsey & Company); Matt Linderman (Partner, Technology Practice, McKinsey & Company); Prakhar Dixit (Partner, McKinsey)
...
- **Type:** session
- **Speakers:** Jesse Lumarie (Software Engineer, Figma)
...
- **Type:** session
- **Speakers:** Ameya Bhatawdekar (Braintrust)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Tereza Tížková (Growth, Factory)
...
- **Track:** Claws & Personal Agents
- **Type:** session
- **Speakers:** Vinoth Govindarajan (Member of Technical Staff, OpenAI)
...
### Building LiteParse: the world's fastest PDF -> markdown parser

- **Time:** 11:10am-11:30am
- **Room:** Track 2
- **Track:** Vision & OCR
- **Type:** sponsor
- **Speakers:** Jerry Liu (CEO, LlamaIndex)
...
- **Track:** Search & Retrieval
- **Type:** session
- **Speakers:** Jo Kristian Bergum (CEO, Hornet.dev)
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Lovina Dmello (Senior Software Developer, NVIDIA)
...
- **Track:** Voice & Realtime AI
- **Type:** session
- **Speakers:** Valeria Wu Fon (Product Manager, Google DeepMind); Tom Ouyang (Principal Engineer, Google DeepMind)
...
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Robert McHardy (Pre-training Lead, poolside); Marah Abdin (Team Lead - Synthetic Data, poolside)
...
- **Track:** AI Architects: Show my Workflow
- **Type:** session
- **Speakers:** Itamar Friedman (Co-Founder & CEO, Qodo)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Charlie Holtz (CEO, Conductor)
...
- **Track:** Vision & OCR
- **Type:** sponsor
- **Speakers:** Merve Noyan (MLE, Hugging Face)
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Moritz Johner (Staff Engineer, Form3)
...
- **Track:** Voice & Realtime AI
- **Type:** session
- **Speakers:** Charlie Guo (Developer Experience Engineer, OpenAI)
...
- **Track:** Forward Deployed Engineering
- **Type:** session
- **Speakers:** Vasuman Moza (Founder & CEO, Varick Agents)
...
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Rayan Garg (CEO, Theta Software)
...
- **Room:** Expo Stage 3 SW
- **Type:** session
- **Speakers:** Simran Arora (Stanford University)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Will Bond (Staff Software Engineer, Uber); Ameya Ketkar (Software Engineer, Uber Technology Inc.)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Daksh Gupta (co-founder/CEO, Greptile)
...
- **Track:** Vision & OCR
- **Type:** sponsor
- **Speakers:** Aditya Gautam (Machine Learning Lead, Meta)
...
- **Track:** Search & Retrieval
- **Type:** session
- **Speakers:** Liad Yosef (Co-creator, MCP Apps)
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Ezra Tanzer (Director, Product Management, Snyk)
...
- **Track:** Claws & Personal Agents
- **Type:** session
- **Speakers:** Neil Zeghidour (Co-founder & CEO, Gradium)
...
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** David Brumley (Chief AI and Science Officer, Bugcrowd, Inc)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Andrew Orobator (Senior Software Engineer, Reddit)
...
- **Track:** AI Architects: Show my Workflow
- **Type:** session
- **Speakers:** Arek Borucki (Machine Learning Platform & Database Engineer, Hugging Face)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Kevin Hou (Engineering Lead @ Antigravity, Google DeepMind)
...
- **Track:** Claws & Personal Agents
- **Type:** session
- **Speakers:** Jean-Denis Greze (Co-Founder & CEO, Town)
...
- **Track:** Search & Retrieval
- **Type:** session
- **Speakers:** Simon Eskildsen (CEO and co-founder, turbopuffer); Jacob Lauritzen (CTO, Legora)
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Eugene Yan (Member of Technical Staff, Anthropic)
...
- **Track:** Voice & Realtime AI
- **Type:** session
- **Speakers:** Paula Dozsa (iOS Engineer, Tolan)
...
### How Forward Deployed Engineering is done at Sierra
...
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Varun Singh (Pre-Training Lead, Arcee AI)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Nachiket Paranjape (Software Engineer, DoorDash); Swaroop Chitlur Haridas (DoorDash)
...
- **Track:** AI Architects: Show my Workflow
- **Type:** session
- **Speakers:** Sarthak Aggarwal (Co-founder, Decawork)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Zach Lloyd (Founder and CEO, Warp)
...
- **Track:** Claws & Personal Agents
- **Type:** session
- **Speakers:** Lance Martin (Member of Technical Staff, Anthropic)
...
- **Track:** Vision & OCR
- **Type:** sponsor
- **Speakers:** Andrew Dai (Co-founder and CEO, Elorian)
...
- **Track:** Search & Retrieval
- **Type:** session
- **Speakers:** Maximilian-David Rumpf (CEO, SID.ai); Lotte Seifert (Founder, SID AI)
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Ethan (Jung Min) Cha (AI Development Lead, The Carlyle Group)
...
- **Track:** Voice & Realtime AI
- **Type:** session
- **Speakers:** Venky B (Founder & CEO, Plivo); Vyas A (Head of Product, Plivo)
...
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Thais Castello Branco (Founder & CEO, Taste Labs)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Kanish Manuja (Principal Software Engineer, Twilio Inc.)
...
- **Track:** AI Architects: Show my Workflow
- **Type:** session
- **Speakers:** Kieran Klaassen (GM of Cora / Compound Engineering, Every/Cora)
...
### River: Shopify’s Slack-Native AI Agent

- **Time:** 2:25pm-2:45pm
- **Room:** Main Stage
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Jevon McDonald
...
- **Track:** Claws & Personal Agents
- **Type:** session
- **Speakers:** Karan Vaidya (Co-founder, Composio)
...
- **Track:** Vision & OCR
- **Type:** sponsor
- **Speakers:** Cody Menefee (Success Engineer, Firecrawl)
...
- **Track:** Search & Retrieval
- **Type:** session
- **Speakers:** Benjamin Clavié (Member of Technical Staff, Mixedbread Inc.)
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Steve Yegge (Icon, Gas Town)
...
- **Track:** Voice & Realtime AI
- **Type:** session
- **Speakers:** Sumanyu Sharma (Founder/CEO, Hamming AI)
...
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Ross Taylor (CEO, General Reasoning); Chengxi Taylor (Co-founder & President, General Reasoning Inc.)
...
- **Track:** AI Architects: Show my Workflow
- **Type:** session
- **Speakers:** Niels Rogge (Machine Learning Engineer, Hugging Face)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Sarah Sachs (Eng Lead, AI, Notion)
...
- **Track:** Claws & Personal Agents
- **Type:** session
- **Speakers:** Tanmai Gopal (CEO/cofounder, PromptQL)
...
- **Track:** Vision & OCR
- **Type:** sponsor
- **Speakers:** Armen Aghajanyan (Co-Founder & CEO, Perceptron AI)
...
- **Track:** Search & Retrieval
- **Type:** session
- **Speakers:** Hiral Shah (Senior Director of Product, AI Applications, Docusign); Sean Sodha (Senior Product Manager, NVIDIA)
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Kim Maida (Founding GTM Engineer, Keycard)
...
- **Track:** Voice & Realtime AI
- **Type:** session
- **Speakers:** Bohan Li (Staff Software Engineer, EliseAi)
...
- **Track:** AI Architects: Show my Workflow
- **Type:** session
- **Speakers:** Nick Heiner (VP of RL Environments, Surge AI)
...
### From raw documents to retrievable knowledge
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Eyal Blum (Software Engineer, Figma)
...
- **Track:** AI Architects: Show my Workflow
- **Type:** session
- **Speakers:** Dan Bjornn (Senior Data Scientist, Lease End)
...
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Vaibhav Gupta (CEO, Boundary)
...
- **Track:** Claws & Personal Agents
- **Type:** session
- **Speakers:** Benjamin Guo (Cofounder, Zo Computer); Rob Cheung (Zo Computer)
...
- **Track:** Vision & OCR
- **Type:** sponsor
- **Speakers:** Krishna Prasad Srinivasan (Head of Vision Models, Sarvam)
...
- **Track:** Search & Retrieval
- **Type:** session
- **Speakers:** Yuval Belfer (Sr. Developer Advocate, AI21); Niv Granot
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Aaron Stanley (CISO, dbt Labs)
...
- **Track:** Voice & Realtime AI
- **Type:** session
- **Speakers:** Midam Kim (ML Engineer, ServiceNow)
...
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Nicolai Ouporov (CEO, Fleet)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Oscar Mullin (Sr. VP of Tech, MercadoLibre)
...
- **Track:** AI Architects: Show my Workflow
- **Type:** session
- **Speakers:** Tushar Jain (EVP of Engineering, Docker)
...
### The Software Factory Survivor's Guide

- **Time:** 3:45pm-4:05pm
- **Room:** Main Stage
- **Track:** Software Factories
- **Type:** session
- **Speakers:** Kyle Mistele (CTO, HumanLayer)
...
- **Track:** Claws & Personal Agents
- **Type:** session
- **Speakers:** Sam Bhagwat (Founder/CEO, Mastra)
...
- **Track:** Search & Retrieval
- **Type:** session
- **Speakers:** Han Xiao (VP, AI, Elastic)
...
- **Track:** Security
- **Type:** sponsor
- **Speakers:** Fouad Matin (Cyber Team Lead, OpenAI)

### Reduce the OUCH: Smarter behavior for AI assistants and robots

- **Time:** 3:45pm-4:05pm
- **Room:** Track 6
- **Track:** Voice & Realtime AI
- **Type:** session
- **Speakers:** Amit Desai (Director, Voice & Assistant AI, Roku)

Voice is our favorite way to command AI assistants and robots – and it's error-prone. The industry's reflex is to chase accuracy. But accuracy is only one knob – we can control system behavior in other ways to increase user satisfaction.

We shift the lens from accuracy to user outcomes. Give the AI agent more than one move: besides acting, let it Stop (reject) or Ask (confirm, clarify, disambiguate). The question stops being "how often are we right?" and becomes "what does each outcome cost the user?" Bad outcomes aren't equally bad to users – so price them relatively, then have the AI system minimize that user cost. Call it OUCH: Outcome User Cost Heuristic; we optimize system behavior to minimize the OUCH. Same accuracy, lower user cost, greater user adoption.

We will walk through practical AI assistant examples illustrating this new approach, then show how the same framework extends across AI environments — smart speakers, TVs, glasses, embodied AI, robots — just reprice the outcomes and swap the Ask UI. 

Why this matters now: the cost of voice command errors is escalating as we move into AI assistants and embodied AI, where wrong actions can be more expensive and dangerous. Mainstream voice adoption won't come from chasing accuracy alone; we need systems to price in the cost of being wrong.

### Tools for data curation and post-training LLMs

- **Time:** 3:45pm-4:05pm
- **Room:** Track 9
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Mahesh Sathiamoorthy (CEO, Bespoke Labs)
...
- **Type:** keynote
- **Speakers:** Erik Meijer (Research Scholar, Leibniz Labs)
...
- **Track:** Software Factories
- **Type:** keynote
- **Speakers:** Lee Robinson (ML, Model Behavior, Cursor)
...
- **Track:** Software Factories
- **Type:** keynote
- **Speakers:** Tariq Shaukat (Chief Executive Officer, Sonar)
...
- **Track:** Autoresearch
- **Type:** keynote
- **Speakers:** Antje Barth (Member of Technical Staff, Amazon AGI Lab)
...
- **Track:** Autoresearch
- **Type:** keynote
- **Speakers:** Benoit Schillings (Vice President of Research, Google DeepMind)
...
- **Track:** Expo Stage 3
- **Type:** session
- **Speakers:** Gabriel Spencer-Harper (CEO, Meticulous)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Varun Shenoy (Cofounder, Long Lake); Rasmus Wissmann (Long Lake)
...
- **Type:** session
- **Speakers:** Alex Volkov (AI Evangelist & Host of ThursdAI, W&B from CoreWeave)
...
- **Track:** Autoresearch
- **Type:** session
- **Speakers:** Richard Socher (CEO & Co-Founder, You.com / Recursive Superintelligence)
...
- **Type:** session
- **Speakers:** Adam Azzam (Member of Product Staff, Modal)
...
- **Type:** session
- **Speakers:** Parth Asawa (CS PhD student, UC Berkeley)
...
- **Track:** Workshops Day 2
- **Type:** session
- **Speakers:** Thor 雷神 Schaeff (Member of the Technical Staff (DevX) at Google DeepMind, Google DeepMind)
...
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Lukas Petersson (Co-Founder, Andon Labs)
...
- **Type:** session
- **Speakers:** Geoffrey Litt (Design Engineer, Notion)
...
- **Track:** Computer Use
- **Type:** session
- **Speakers:** Dhruv Batra (Co-founder & Chief Scientist, Yutori)
...
- **Type:** session
- **Speakers:** Kurtis Van Gent (Senior Staff Software Engineer, Google); Prerna Kakkar (Senior Software Engineer, Google)
...
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** Diogo Almeida (CEO, TypeSafe AI)
...
- **Room:** Track M
- **Type:** sponsor
- **Speakers:** Tina Manghnani; Keiji Kanazawa (Principal Product Manager, Microsoft)
...
- **Track:** Expo Stage 2
- **Type:** session
- **Speakers:** Justin Reock (Deputy CTO, DX)
...
- **Track:** Expo Stage 4
- **Type:** session
- **Speakers:** Matt Lawler (Forward Deployed Engineer Lead, AssemblyAI)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Andrew Garvin (Cofounder of Metronome, Stripe)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Ronak Malde (Co-Founder and CEO, Trajectory)
...
### From Alert to PR: Building an Autonomous Agent Debugger

- **Time:** 11:10am-11:30am
- **Room:** Track 5
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Jason Lopatecki (CEO, Arize)
...
- **Track:** Design Engineering
- **Type:** session
- **Speakers:** Max Drake (Product Engineer, tldraw)
...
- **Track:** Computer Use
- **Type:** session
- **Speakers:** Pierluca D'Oro (Founder, Programma Labs)
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Kevin Madura (Director, Advanced Technology, AlixPartners)
...
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** Sean Cai (Independent / State of Data)
...
- **Room:** Expo Stage 3 SW
- **Type:** session
- **Speakers:** Jake Broekhuizen (Deployed Engineer, LangChain)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Varun Pant (Builder, NeuroSymbolic AI, AWS)
...
- **Track:** AI Architects: Tokenmaxxing
- **Type:** session
- **Speakers:** Ankit Jain (Founder & CEO, Aviator)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Stefania Druga (Research Scientist, Sakana.ai)
...
- **Track:** Sandbox & Platform Engineering
- **Type:** session
- **Speakers:** Ivan Burazin (CEO, Daytona)
...
- **Track:** Robotics & World Models
- **Type:** sponsor
- **Speakers:** Jason Ma (CTO and co-founder, Dyna Robotics)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Jack Morris (Cofounder, Engram)
...
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Soumya Gupta (Uber); Jai Chopra (Product Manager, Uber)
...
- **Track:** Design Engineering
- **Type:** session
- **Speakers:** Jonathan Gordon (Founder, ReWeaver AI)
...
- **Track:** Computer Use
- **Type:** session
- **Speakers:** Paul Klein IV (Founder & CEO, Browserbase)
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Ajay Prakash (Senior Staff Software Engineer, Linkedin)
...
- **Track:** Data Quality
- **Type:** session
- **Speakers:** Uri Rolls (CEO, Arithmetic)
...
- **Room:** Track M
- **Type:** sponsor
- **Speakers:** Arun Sekhar (Microsoft); Pamela Fox (Principal Cloud Advocate, Microsoft)
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Anant Srivastava (MongoDB)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Imad Touil (Distinguished Engineer, QuantumBlack, AI by McKinsey)
...
- **Track:** Autoresearch
- **Type:** session
- **Speakers:** Elie Bakouch (Research Engineer, Prime Intellect)
...
- **Track:** Sandbox & Platform Engineering
- **Type:** session
- **Speakers:** Samuel Colvin (Founder & CEO, Pydantic)
...
- **Track:** Robotics & World Models
- **Type:** sponsor
- **Speakers:** Sandhya Subramani (Senior Developer Advocate, GenAI, Amazon Web Services)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Yu Su (Co-founder and CEO, NeoCognition)
...
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Rustem Feyzkhanov (Senior Engineering Manager - AI Platform, Snorkel AI)
...
- **Track:** Design Engineering
- **Type:** session
- **Speakers:** Maximillian Piras (Founding Designer, Yutori)
...
- **Track:** Computer Use
- **Type:** session
- **Speakers:** Corey Gallon (Managing Director, Rexmore)
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Brandon Waselnuk (Developer Relations, Unblocked)
...
### Post-Training Optimizations: Staleness, Entropy Preservation, and More

- **Time:** 12:05pm-12:25pm
- **Room:** Track 9
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** Raymond Feng (Researcher, Applied Compute)

### Tokenomics: From AI Spend to AI Value (Working Lunch)
...
Working-lunch continuation of the Tokenomics session: deeper discussion on managing token spend, controls, and workflow-level value across the enterprise.
...
- **Track:** AI Architects: Tokenmaxxing
- **Type:** session
- **Speakers:** Nicholas Arcolano (Head of AI & Research, Jellyfish)
...
- **Track:** Autoresearch
- **Type:** session
- **Speakers:** Tim Sweeney (Principal Engineer, Weighs & Biases by Coreweave); Zubin Aysola (Senior Software Engineer Weave, Weights & Biases by CoreWeave)
...
- **Track:** Sandbox & Platform Engineering
- **Type:** session
- **Speakers:** Abhishek Bhardwaj (Member of Technical Staff, RL & Agent Infrastructure, OpenAI)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Sara Hooker (CEO, and Co-founder, Adaption)
...
- **Track:** Workshops Day 3
- **Type:** session
- **Speakers:** John Lindquist (Agentic Instructor, egghead.io)
...
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Chris Souza (YouTube); Preetika Bhateja (Product Manager, Google); Daniel Bump (YouTube)
...
- **Track:** Computer Use
- **Type:** session
- **Speakers:** Gaurav Mishra (Amazon AGI Lab)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Rachna Srivastava (Enterprise Architect, DFPI)
...
- **Track:** AI Architects: Tokenmaxxing
- **Type:** session
- **Speakers:** Matthew Jewkes (Cofounder & CTO, Standard Cybernetics)
...
- **Track:** Autoresearch
- **Type:** session
- **Speakers:** Zhengyao Jiang (CEO & Cofounder, Weco AI)
...
- **Track:** Robotics & World Models
- **Type:** sponsor
- **Speakers:** Deepak Pathak (Co-Founder & CEO, Skild AI)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Vivek Trivedy (Head of Applied Research, LangChain)
...
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Maor Bril (Chaos Catalyst, Character.ai)
...
- **Track:** Computer Use
- **Type:** session
- **Speakers:** TBD — Bright Data speaker
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Prukalpa Sankar (Founder & Co-CEO, Atlan)

AI without context is confidence without comprehension. Your agent can parse queries, generate SQL, and produce articulate explanations — and still be completely wrong. Not because the model is weak. Because it has no world model of your business. This talk cuts through the context engineering hype and gets concrete. Drawing on 500+ enterprise deployments — Mastercard, Nasdaq, GM, Rocket Mortgage, CME Group — Prukalpa Sankar breaks down the four layers every agent is missing: the data it can access, the meaning behind it, the business rules nobody ever wrote down, and the user context that determines what a correct answer actually looks like. Even OpenAI needed six layers of structured context to make their own internal data agent work — cutting query time from 22 minutes to 90 seconds. The pattern is consistent across every production deployment we've seen. The takeaway: a practical four-layer audit framework you can apply to your own stack on Monday.
...
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** Joseph Wang (CEO, Emulated)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Mingsheng Hong (VP of AI, Bluesky)
...
- **Track:** AI Architects: Tokenmaxxing
- **Type:** session
- **Speakers:** Keiji Kanazawa (Principal Product Manager, Microsoft)
...
- **Track:** Autoresearch
- **Type:** session
- **Speakers:** Lakshya Agrawal (Creator and maintainer of GEPA, GEPA)
...
- **Track:** Sandbox & Platform Engineering
- **Type:** session
- **Speakers:** Kevin Orellana (Software Engineer, Amazon Web Services)
...
### Distillation and Continual Learning for Enterprise AI

- **Time:** 2:25pm-2:45pm
- **Room:** Track 3
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Samuel Denton (Platform Research Lead, Applied Compute)
...
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Mihnea Munteanu (Senior Product Lead, YouTube)
...
- **Track:** Design Engineering
- **Type:** session
- **Speakers:** Eve Bouffard (Head of Design, Y Combinator)
...
- **Track:** Computer Use
- **Type:** session
- **Speakers:** Francesco Bonacci (Co-founder & CEO, Cua); Dillon DuPont (CTO, Cua)
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Liad Yosef (Co-creator, MCP Apps); Ido Salomon (Co-Creator, MCP Apps)
...
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** Kenny Workman (CTO, LatchBio)
...
- **Room:** Track M
- **Type:** sponsor
- **Speakers:** Marco Casalaina (Microsoft)
...
- **Room:** Expo Stage 4 SE
- **Type:** session
- **Speakers:** Eli Cohen (Director of Technology Incubation, Snyk)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Roberto Milev (Chief Architect, Navan); Uday Kanagala (Navan)
...
- **Track:** Sandbox & Platform Engineering
- **Type:** session
- **Speakers:** Tomás Hernando Kofman (CEO & Co-Founder, Not Diamond)
...
- **Track:** Autoresearch
- **Type:** session
- **Speakers:** Tejas Bhakta (CEO, Morph)
...
- **Track:** Sandbox & Platform Engineering
- **Type:** session
- **Speakers:** Adi Singh (Co-founder, AgentMail)
...
- **Track:** Robotics & World Models
- **Type:** sponsor
- **Speakers:** Cormac Brick (Principal Engineer, Google AI Edge, Google)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Ben Hylak (CTO, Raindrop)
...
- **Track:** Workshops Day 3
- **Type:** session
- **Speakers:** Brian Douglas (CoFounder, Paper Compute Company); John McBride (Co-Founder, CTO, Paper Compute Co.)
...
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Akele Reed (Principal AI Engineer, Sondermind); Dave Revere (SonderMind); Doug Keller (Senior Staff AI Engineer, SonderMind)
...
- **Track:** Computer Use
- **Type:** session
- **Speakers:** Patricija Žemaitytė (Product Manager, Oxylabs)
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Dustin Mihalik (Technical Fellow, Indeed)
...
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** Olive Song (RL Lead, MiniMax); Dan Fu (VP of Kernels, Together AI)
...
- **Room:** Expo Stage 3 SW
- **Type:** session
- **Speakers:** Morgan Willis (Amazon Web Services (AWS))
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Carlos Sanchez (Principal Scientist, Adobe)
...
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** David Corbitt (Head of Product, Serverless Training, CoreWeave)
...
- **Track:** Autoresearch
- **Type:** session
- **Speakers:** Roland Gavrilescu (Co-Founder, CEO, Introspection); Julian Bright (Introspection)
...
- **Track:** Sandbox & Platform Engineering
- **Type:** session
- **Speakers:** Robert Brennan (CEO, OpenHands)
...
- **Track:** Robotics & World Models
- **Type:** sponsor
- **Speakers:** Amit Navindgi (Senior Staff Software Engineer, Zoox)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Shlok Khemani (Independent Researcher, -)
...
- **Track:** Workshops Day 3
- **Type:** session
- **Speakers:** Brian Douglas (CoFounder, Paper Compute Company)
...
- **Track:** Evals
- **Type:** sponsor
- **Speakers:** Ishan Anand (Chief AI Officer (CAIO), InsightSciences.ai)
...
- **Track:** Design Engineering
- **Type:** session
- **Speakers:** Jeremiah Lowin (Founder & CEO, Prefect)
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Cornelia Davis (Principal Technologist, Temporal)
...
- **Track:** Posttraining & Midtraining
- **Type:** session
- **Speakers:** Ali Khial (Head of AI/ML, G2i)
...
- **Room:** Expo Stage 2 NW
- **Type:** session
- **Speakers:** Dominik Kundel (Developer Experience Lead, OpenAI)
...
- **Room:** Expo Stage 3 SW
- **Type:** session
- **Speakers:** Jetashree Ravi (Fireworks AI)
...
- **Room:** Expo Stage 4 SE
- **Type:** session
- **Speakers:** Tarun Sunkaraneni (Amazon AGI)
...
- **Track:** AI Architects: Tokenmaxxing
- **Type:** session
- **Speakers:** Rania Khalaf (Chief AI Officer, WSO2)
...
- **Track:** Autoresearch
- **Type:** session
- **Speakers:** Erina Karati (Former Microsoft, Supercell); Arunachalam Manikandan (AI Engineer, Co-Founder, University of Minnesota)
...
- **Track:** Sandbox & Platform Engineering
- **Type:** session
- **Speakers:** Jonathan Kelley (Founder, Dioxus Labs)
...
- **Track:** Robotics & World Models
- **Type:** sponsor
- **Speakers:** Cyrus Clarke (Researcher, MIT Media Lab)
...
- **Track:** Memory & Continual Learning
- **Type:** session
- **Speakers:** Ben Holmes (Dev Rel Lead, Warp)
...
- **Track:** Design Engineering
- **Type:** session
- **Speakers:** Vincent Wendy (Senior Creative Designer, AI Engineer)
...
- **Track:** Context Engineering
- **Type:** session
- **Speakers:** Alex Hancock (Software Engineer, Block)
...
- **Track:** Autoresearch
- **Type:** keynote
- **Speakers:** Addy Osmani (formerly, Google)
...
- **Track:** Autoresearch
- **Type:** keynote
- **Speakers:** George Cameron (Co-Founder, Artificial Analysis); Micah Hill-Smith (CEO, Artificial Analysis)
...
- **Track:** Software Factories
- **Type:** keynote
- **Speakers:** Matt Pocock (Educator, content creator and engineer, Total TypeScript / AI Hero)
...
- **Track:** Harness Engineering
- **Type:** keynote
- **Speakers:** Maxime Rivest (Core Contributor, DSPy); Isaac Miller (Lead Maintainer of DSPy; Co-Founder, cmpnd)
...
### How Tag changed Labs

- **Time:** 10:00am-10:20am
- **Room:** Main Stage
- **Track:** Harness Engineering
- **Type:** keynote
- **Speakers:** Mike Krieger (Head of Labs, Anthropic)
...
- **Track:** Graphs
- **Type:** keynote
- **Speakers:** Emil Eifrem (Co-Founder and CEO, Neo4j)
...
- **Track:** Agentic Commerce
- **Type:** session
- **Speakers:** Jennifer Lee (Product Lead, Machine Payments & Agentic Commerce, Stripe)
...
Most teams start with one AI coding agent on a single developer’s machine. But scaling that work across large, complex codebases and process automation tasks is difficult in large organizations. How do teams move agent workloads to the cloud? What happens when different tools like Claude Code and Codex are used across teams? How do agents coordinate and share what they’ve learned?

At Warp, merged PRs are created by agents running on Oz, Warp’s cloud agent infrastructure. In this session, we'll show how to move from a single local agent to the cloud, and fan out tasks across multiple harnesses (Claude Code, Codex, Gemini CLI) coordinated from a single orchestrator. The session demonstrates multi-harness management, multi-agent orchestration, and Agent Memory keeping context intact across sessions.

We'll talk about the challenges of building Oz and how this agent infrastructure helps accelerate Warp’s customers and its engineering organization.
3:11 PM

### Token Should Have Jobs

- **Time:** 10:45am-11:05am
- **Room:** Main Stage
- **Track:** Harness Engineering
- **Type:** session
- **Speakers:** Katelyn Lesse (Head of Engineering, Claude Platform, Anthropic); Angela Jiang (Head of Product, Claude Platform, Anthropic)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** Nidhi Kaushik Vyas (Product, Google DeepMind)
...
- **Track:** AI in Finance
- **Type:** session
- **Speakers:** Brendan Rappazzo (Machine Learning Scientist, Morgan Stanley)
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** Stephen Chin (VP of Developer Relations, Neo4j)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Everett Berry (Head of GTM Engineering, Clay)
...
- **Type:** session
- **Speakers:** Chaitanya Asawa (Head of Engineering for Clinical Decision Support, Abridge)
...
- **Type:** session
- **Speakers:** Serena Ge (CEO, Datacurve)
...
- **Track:** Inference
- **Type:** session
- **Speakers:** Nishant Gupta (Software Engineer, Tech Lead, Meta); Naman Ahuja (Senior Software Engineer, Meta)
...
- **Room:** Expo Stage 3 SW
- **Type:** session
- **Speakers:** Michael Patterson (Coder)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Dmitry Buykin (Applied AI Lead, Staff Software Engineer, Maersk)
...
- **Track:** AI Architects: AI Factories
- **Type:** session
- **Speakers:** Tisha Chawla (Software Engineer, Microsoft); Susheem Koul (Senior Software Engineer, Microsoft)
...
- **Track:** Agentic Engineering
- **Type:** session
- **Speakers:** Nikita Kothari (Senior Member of Technical Staff, Salesforce)
...
- **Type:** session
- **Speakers:** James Russo (Software Engineer, HeyGen)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** Harshal Bhangale (Staff Software Engineer, Circle)
...
- **Track:** AI in Finance
- **Type:** session
- **Speakers:** Udi Menkes (Principal Product Manager, Intuit)
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** Yohei Nakajima (Managing Partner, Untapped Capital)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Aliisa Rosenthal (General Partner, Acrew Capital)
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Rashi Agrawal (Head of Agentic AI, Hinge Health)
...
- **Track:** Agentic Engineering
- **Type:** session
- **Speakers:** Frank Coyle (Lecturer, UCALBerkeley / Founder AI/Edge, UCAL Berkeley)
...
- **Track:** Inference
- **Type:** session
- **Speakers:** Qianru Lao (Member of Technical Staff, OpenAI); Lu Zhang (Member of Technical Staff, OpenAI)
...
- **Room:** Expo Stage 1 NE
- **Type:** session
- **Speakers:** Miguel González Fernández (Browserbase); Corby Rosset (Microsoft Research)
...
- **Room:** Expo Stage 3 SW
- **Type:** session
- **Speakers:** Kwindla Kramer (CEO, Daily); Neil Zeghidour (Co-founder & CEO, Gradium)
...
- **Track:** Inference
- **Type:** session
- **Speakers:** Daniel Kim (Head of Growth, Cerebras); Michelle Nguyen (Co-Founder, Gimlet Labs)
...
- **Track:** AI Architects: AI Factories
- **Type:** session
- **Speakers:** Khaled Alashmouny (Founder & CEO, AIDAChip); Abduallah Mohamed (VP of AI/ML, AIDAChip)
...
- **Track:** Agentic Engineering
- **Type:** session
- **Speakers:** Michael Grinich (Founder & CEO, WorkOS)
...
- **Track:** Generative Media
- **Type:** session
- **Speakers:** Ekaterina Deyneka (Founder & CEO, Reelful)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** Anil Nadiminti (Sr Solutions Architect, Amazon Web Services (AWS))
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** Mike Phipps (Lead AI Engineer, Gates Foundation)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Flora Liu (Software engineer, Notion)
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Jared Joselowitz (AI Research Engineer, Ufonia)
...
- **Track:** Agentic Engineering
- **Type:** session
- **Speakers:** Manish Kapur (Sonar); Anirban Chatterjee
...
- **Track:** Inference
- **Type:** session
- **Speakers:** Ashok Chandrasekar (Staff Software Engineer, Google); Jason Kramberger (Software Engineer, Google)
...
- **Room:** Expo Stage 1 NE
- **Type:** session
- **Speakers:** Giedrius Steimantas (Oxylabs)
...
- **Track:** Inference
- **Type:** session
- **Speakers:** George Hu (President, Fireworks)
...
- **Track:** Harness Engineering
- **Type:** session
- **Speakers:** Mike Chambers (Amazon Web Services (AWS))
...
- **Track:** Generative Media
- **Type:** session
- **Speakers:** Arturo Nunez (Founder, Nereu)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** Jan Curn (Founder & CEO, Apify)
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** Omri Bruchim (Engineering Group Manager, Monday)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Arman Vaziri (Senior Staff Software Engineer, Ramp)
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Vivek Muppalla (VP AI Engineering, Hippocratic AI)
...
- **Track:** Agentic Engineering
- **Type:** session
- **Speakers:** Denys Linkov (Head of ML, Wisedocs)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Josh Leavitt (Sr. Director of AI & Data, Coinbase)
...
- **Track:** AI Architects: AI Factories
- **Type:** session
- **Speakers:** Patrick Debois (Member Technical Staff, Tessl)
...
- **Track:** Generative Media
- **Type:** session
- **Speakers:** Todd Fisher (Head of Engineering Launching 0-1 startups, Philo Ventures)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** Rodrigo Coelho (CEO, Edge & Node); Pranav Maheshwari (Director of Integrations, Edge And Node)
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** Ritvik Pandya (Engineering Manager, JP Morgan Chase)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Alex Bauer (Co-founder, Upside)
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Clay Cockrell (Co-Founder, CoupleWork AI); Tony Fabrikant (Co-founder, CoupleWork AI)
...
- **Track:** Inference
- **Type:** session
- **Speakers:** Philip Kiely (Developer Relations, Baseten)
...
- **Room:** Expo Stage 3 SW
- **Type:** session
- **Speakers:** Sharmila Chockalingam
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Brian Lewis (AI Product Lead, Millennium)

Intended audience: AI startup founders and teams. Goal: Help AI startups understand what kind of requirements enterprises will demand of them to successfully sign a contract for ARR. Discussion points: 1) what good (AND BAD) initial sales calls look like from 'the other side', 2) how to (and NOT TO) structure a good pilot program, 3) security, security, security 4) how to scale internal adoption 5) how to get businesses to WANT to renew your contract (well designed pricing structures, reasonable terms, etc.) Why am I doing this: See the 'speaker pitch' below. I want the AI startup ecosystem to succeed. It will help them make more money, get embedded into businesses that need their tools, and selfishly make my dayjob a lot easier.
...
- **Track:** Harness Engineering
- **Type:** session
- **Speakers:** Giselle van Dongen (Developer Advocate, Restate)
...
- **Track:** Generative Media
- **Type:** session
- **Speakers:** Lina Colucci (CEO, LemonSlice)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** Anna Spysz (Developer Relations Engineer, Stripe)
...
- **Track:** AI in Finance
- **Type:** session
- **Speakers:** Lucas Palma (Information Security Manager, Nubank)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Christopher Burns (Founder, Inth)
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Vasant Kearney (CEO and Founder, Onlay)
...
### Rob Wachen — transformer-only ASICs for inference

- **Time:** 1:55pm-2:15pm
- **Room:** Track 9
- **Track:** Inference
- **Type:** session
- **Speakers:** Rob Wachen (Co-founder and President, Etched)
...
- **Room:** Track M
- **Type:** sponsor
- **Speakers:** Arun Sekhar (Microsoft)
...
- **Room:** Expo Stage 4 SE
- **Type:** session
- **Speakers:** Melanie Warrick (Temporal Technologies)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Kunal Lanjewar (Staff Engineer, Riot Games)
...
- **Track:** Generative Media
- **Type:** session
- **Speakers:** Keegan McCallum (Founder, uRun)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** Ahnaf Prio (Senior Engineering Manager, Best Buy)
...
- **Track:** AI in Finance
- **Type:** session
- **Speakers:** Ramana Siddanth Emani (Data Scientist, Auditoria AI)
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** James Le (Head of Developer Experience, TwelveLabs)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Jeffrey Wang (Co-founder, Exa)
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Ayush Bhardwaj (Tech Lead, Allos AI)
...
- **Track:** Agentic Engineering
- **Type:** session
- **Speakers:** Justin Smith (Founding Product Engineer, Resolve AI)
...
- **Track:** Inference
- **Type:** session
- **Speakers:** Byung-Gon (Gon) Chun (Founder & CEO, FriendliAI)
...
- **Track:** AI-Native Enterprises
- **Type:** session
- **Speakers:** Salman Munaf (Lead Site Reliability Engineer, TikTok)
...
- **Track:** AI Architects: AI Factories
- **Type:** session
- **Speakers:** Sebastian Fox (CEO, Composo)
...
- **Track:** Generative Media
- **Type:** session
- **Speakers:** Ahmed Ahres (Head of Product & GTM, Reactor)
...
### Simulationmaxxing for 20x Faster Agent Dev
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** Shafik Quoraishee (Staff Engineer, The New York Times); Joanne Song (The New York Times Games)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Justin Joyce (Principal Sales Operations and Strategy Manager, Cloudflare)

AI Engineer transforming how Go-To-Market teams interact with data. By automating advanced SQL generation, structuring standardized executive datasets, and deploying on-the-fly analytical agents, I build systems that bring the story out of the data automatically—empowering leaders to spend less time searching and more time strategizing
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Dan Feng (Senior Director of Engineering, Maven Clinic)
...
- **Track:** Inference
- **Type:** session
- **Speakers:** Yuchen Fama (Senior Principal Product Manager, Red Hat); Michey Mehta (Red Hat); Ashish Kamra (Senior Manager, Software Engineering, Red Hat)
...
- **Room:** Expo Stage 1 NE
- **Type:** session
- **Speakers:** Karthik Ranganathan (Yugabyte); Heather Downing (Yugabyte)
...
- **Room:** Expo Stage 4 SE
- **Type:** session
- **Speakers:** Remy Guercio (Tailscale)
...
- **Track:** AI Architects: AI Factories
- **Type:** session
- **Speakers:** Sachin Malhotra (Member of Technical Staff, Anthropic)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** Gus Iwanaga (General Manager (Product, UX, Eng), commercetools)
...
- **Track:** AI in Finance
- **Type:** session
- **Speakers:** Yogendra Miraje (Principal AI Engineer, FactSet)
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** Daniel Chalef (Founder and CEO, Zep AI)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Bil Erdenekhuyag (Intercom)
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Anuj Iravane (Head of AI, Anterior)
...
- **Track:** Inference
- **Type:** session
- **Speakers:** Asaf Gardin (Senior Software Engineer/Inference Engineer, AI21); Yuval Belfer (Sr. Developer Advocate, AI21)
...
- **Track:** Harness Engineering
- **Type:** session
- **Speakers:** Philipp Schmid (Member of Technical Staff, Google DeepMind)
...
- **Track:** Agentic Commerce
- **Type:** sponsor
- **Speakers:** David Levine (Founder & CEO, Kiduna Club)
...
- **Track:** AI in Finance
- **Type:** session
- **Speakers:** Sai Krishna Rallabandi (Director, Data Science, Fidelity Investments)
...
- **Track:** Graphs
- **Type:** sponsor
- **Speakers:** Subbiah Sethuraman (Partner, ZS Associates); Abhilash Asokan (ZS)
...
- **Track:** AI in GTM
- **Type:** session
- **Speakers:** Stephanie Jarmak (Agent Advocate, Sourcegraph)
...
- **Track:** AI in Healthcare
- **Type:** session
- **Speakers:** Christopher Lovejoy (Member of Technical Staff, Anthropic); Saul Howard (VP Engineering, Anterior)
...
- **Track:** Agentic Engineering
- **Type:** session
- **Speakers:** Saoud Rizwan (Founder & CEO, Cline)
...
- **Room:** Main Stage
- **Type:** keynote
- **Speakers:** Garry Tan (President & CEO, Y Combinator)
...
- **Room:** Main Stage
- **Type:** keynote
- **Speakers:** Howie Liu (CEO, Airtable)
